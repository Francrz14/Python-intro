...
my_str = "Hola soy Fran y tengo 37 años"
print(my_str.format(37))

#%% left-align, center y right-align

my_str = "Hola soy Fran y tengo {age:<10} años."
print(my_str.format(age = 37))
my_str = "Hola soy Fran y tengo {age:^10} años."
print(my_str.format(age = 37))
my_str = "Hola soy Fran y tengo {age:<10} años."
print(my_str.format(age = 37))
...
# %% signo a la Izq
my_str = "En el polo norte, hace {temp} grados."
...
my_str = "En el mundo, hay {pob:,} de personas."
print(my_str.format(pob = 80024400850))
my_str = "En el mundo, hay {pob:_} de personas."
print(my_str.format(pob = 80024400850))
#%% formato binario
...
my_str = "El número 1111101 del binario al decimal es: {:d}"
print(my_str.format(0b1111101))
